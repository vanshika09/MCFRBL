...
public class CrossCheck{
	...
	public String getAssetType()
	{
		...
		try {
			...
			Query query1=null;
			query1 = session.createSQLQuery("select F.furnishing_asset_id,P.furnishing_no from public.furnishing_tran as F, paint_tran as P where  P.paint_asset_id=F.paint_asset_id and P.furnishing_no is not null");
