...
<table>
<tr>
	<td style="color:#0000A0;"><b>SELECT RAILWAYS</b></td>
	<td>
		<select name="railway_type">
		...
		%>
 		<option value="All Railways"  selected>All Railways</option>
		</select>
	</td>
</tr>
<tr>
	<td style="color:#0000A0;"><b>SELECT COACH TYPE</b></td>
	<td>
		<select name="Coach_type">
		<option value="ALL Coach Type"  selected>All Coach Type</option>
		 <%
		for(int i=0;i<rowcount2;i++)
		{
...
<tr>
	<td style="color:#0000A0;"><b>SELECT YEAR</b></td>
	<td>
		<select name="year">
...
<tr>
	<td style="color:#0000A0;"><b>SELECT MONTH</b></td>
	<td>
		<select name="months">
...
<input type="submit" value="submit" id="submitButtonid" align="center" onclick="window.location.href='demo2.jsp'" /> 
</form>
</div>
</body>
</html>