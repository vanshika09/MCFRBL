...
<script src="<%=contextpath %>/newdashboard/html2pdf.bundle.min.js"></script>
		...
		<script src="<%=contextpath %>/newdashboard/jquery-3.3.1.js"></script>	
 		...
 		<script src="<%=contextpath %>/newdashboard/chartjs-plugin-zoom.min.js"></script>
 		<script src="<%=contextpath %>/newdashboard/hammer.min.js"></script>
 		<script src="<%=contextpath %>/newdashboard/moment.min.js"></script>
...
<div align="center" class="nopadding">
<canvas id="myCoachProdNut" width="410px" height="200px">
</canvas>
</div>
...
<div align="center" class="nopadding">
<canvas id="myCWPChart" width="600px" height="200px"></canvas> 
</div>
<div align="center">
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#myCWModalRow2">View Data</button>
</div>
...
<div align="center" class="nopadding">
<canvas id="mySWPChart" width="500px" height="200px"></canvas> 
</div>
<div align="center">
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#mySWModalRow2">View Data</button>
</div>
...
<script>
  ...
  var canvas = document.getElementById('myCWPChart');
  new Chart(canvas, {
	    type: 'bar',
	    data: {
	    	/* labels: ['a', 'b', 'c', 'd', 'e'], */
...
<script>
  ...
  var canvas = document.getElementById('mySWPChart');
  new Chart(canvas, {
	    type: 'bar',
	    data: {
