...
$('#datepickerRelease').datepicker({
            ...
            toolbar: {
           	 items: [
           		 
           		 {
                        ...
                        text: 'Release for Schedule',
                        click: function () {
                        	
                        	 var $selectedRows = $('#MachineScheduleDueTableContainer').jtable('selectedRows');
                    	 	 if ($selectedRows.length<1)
                    		 alert("Please select a row for which you want to sent for Schedule Activity");
                    	 	 else{
                    	 		var record;
							...
							//	$('#datepickerRelease').datepicker('option', 'minDate', new Date(record.scheduleDate));
								
            					
                    	 	 	$("#exitDialog").dialog({
                    	 	 		title : 'Release Machine  '+record.machineDescription + 'for Schedule',                     	 	 		
                    	 	 		close: function (e, u) {
              	 		              //$(".formError").remove();
 		 							...
 		 							buttons: {
	                                    Submit: {
	                                       text: "Submit",
	                                    	...
	                                    	var c=confirm("Verify data before release, You cant not edit after release for schedule");
	                                    	if(c==false){return false;}
	                                    		    	   
	                                    	$.ajax({
	                    						url : "releaseMachineSchedule",  //action-name as defined in struts.xml
	                    						dataType: 'json', 
	                    						data : {
	...
	actions : {
 			listAction: 'listmachineDueForSchedule',
 			  },
