       ...
       <tr>
	    <td  title=" <%=rs.getString(2)%>"  data-toggle="collapse" data-target="#group<%=a_id%>" aria-expanded="false"  >
	      ...
	      <span class="glyphicon glyphicon-wrench" style='font-size:15px' > </span>
	        <%} %>
	        <%if((rs.getString(1)).equalsIgnoreCase("Testing")) {%>
	    	     ...
	    	     ResultSet rs3=st1.executeQuery("select shell_transaction_id,assembly_start_date,assembly_end_date,assembly_dispatch_date,shell_type,expected_exit_date  from public.shell_tran  ");
	    	      ...
	    	      <% }//Shell ends here. 
	    	        ...
	    	        //Paint Code starts here
	    	         if(rs.getString(1).equalsIgnoreCase("Paint"))
	    	        { 	   
	    	     ResultSet rs4=st1.executeQuery("select B.shell_no, A.assembly_start_date,A.assembly_end_date,A.assembly_dispatch_date,A.shell_type,A.expected_exit_date  from public.paint_tran A, public.shell_tran B where A.shell_asset_id = B.shell_asset_id  ");
	    	      ...
	    	      <% }//Paint ends here
	    	        ...
	    	        //Furnishing Code starts here
	    	         if(rs.getString(1).equalsIgnoreCase("Furnishing"))
	    	        { 	   
	    	     ResultSet rs5=st1.executeQuery("select B.furnishing_no,A.assembly_start_date,A.assembly_end_date,A.assembly_dispatch_date,A.shell_type,A.expected_exit_date  from public.furnishing_tran A, public.paint_tran B where A.paint_asset_id = B.paint_asset_id ");
