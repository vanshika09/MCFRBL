...
<li class="dropdown">
 	...
 	<span class="glyphicon glyphicon-dashboard"></span></a>
        <ul class="dropdown-menu" id="#">
			...
			<li><s:a href="layout-shop" target= "_blank">Shop Progress</s:a></li>
			<li><s:a href="layout-shop-trial" target= "_blank">Shop Progress Trial</s:a></li>
			<li><a href="dashboard-component?bogie_asset_id=3" target= "_blank">Bogie Component</a></li>
		</ul>
</li>
<li class="dropdown">
