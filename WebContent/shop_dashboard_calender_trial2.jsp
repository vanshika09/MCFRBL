	       ...
	       %>
	    	  <td>
	    	     <% //wheelset 
	    	       if(rs.getString(1).equalsIgnoreCase("Wheel"))
	    	        { 	   
	    	     ResultSet rs1=st1.executeQuery("select wheelset_transaction_id,assembly_start_date,assembly_end_date,assembly_dispatch_date  from wheelset_tran  ");
              ...
              <button   id="stage_but" title="RBL NO:<%=rs1.getString(1) %><%out.println("\n");%>  Date of mounting:<%=rs1.getDate(2)%> <%out.println("\n");%>  Completion Date: <%=rs1.getDate(3)%> <%out.println("\n");%>  Dispatch Date: <%=rs1.getDate(4)%>"   
	    	     ...
	    	     if(rs.getString(1).equalsIgnoreCase("Bogie"))
	    	        { 	   
	    	     ResultSet rs2=st1.executeQuery("select bogie_set_trx_id,assembly_start_date,assembly_end_date,assembly_exit_date  from bogieset_trans  ");
	    	      ...
	    	      <% } //bogie set ends here
	    	        ...
	    	        //Shell
	    	         if(rs.getString(1).equalsIgnoreCase("Shell"))
	    	        { 	   
	    	     ResultSet rs3=st1.executeQuery("select shell_transaction_id,assembly_start_date,assembly_end_date,assembly_dispatch_date,shell_type  from shell_tran  ");
	    	      ...
	    	      <% }//Shell ends here. 
	    	        ...
	    	        //Paint Code starts here
	    	         if(rs.getString(1).equalsIgnoreCase("Paint"))
	    	        { 	   
	    	     ResultSet rs4=st1.executeQuery("select paint_asset_id,assembly_start_date,assembly_end_date,assembly_dispatch_date,shell_type  from paint_tran  ");
	    	      ...
	    	      <% }//Paint ends here
	    	        ...
	    	        //Furnishing Code starts here
	    	         if(rs.getString(1).equalsIgnoreCase("Furnishing"))
	    	        { 	   
	    	     ResultSet rs5=st1.executeQuery("select furnishing_asset_id,assembly_start_date,assembly_end_date,assembly_dispatch_date,shell_type  from furnishing_tran  ");
	    	      ...
	    	      <% }//Furnishing ends here  
	    	         ...
	    	         if(rs.getString(1).equalsIgnoreCase("Finishing"))
	    	        { 	   
	    	     ResultSet rs6=st1.executeQuery("select finishing_asset_id,f.assembly_start_date,f.assembly_end_date,f.assembly_dispatch_date,s.shell_type from finishing_tran f,shell_tran s where f.shell_asset_id=s.shell_asset_id ");
