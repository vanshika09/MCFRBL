...
int bogie_asset_id= Integer.parseInt(request.getParameter("bogie_asset_id"));
...
<birt:viewer id="birtViewer" 
				reportDesign="reports/flatBogieSipReport.rptdesign"
				pattern="frameset" 
				scrolling="yes" 
				
				showParameterPage="false">
				<birt:param name="bogie_asset_id" value='<%=bogie_asset_id%>'></birt:param>
