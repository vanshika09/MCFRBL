...
<div id="ShellProductionTableContainer"></div>
 <div id="detailDialog" style="height: 200%; width:50%; display:none;z-index: 9;" ></div>
    <div id="shellClearanceMemo" style="height:150%; width:200%; display:none;z-index: 9;" >
            <h3 style="text-align: center;">Quality Control Clearance Memo for BogieSet</h3>
            <br>
         <table>
          <tr>
          <th>DOC No.</th><td colspan="2"><input type="text"  style="width: 200px;" name="docNoQualityClearance" id="docNoQualityClearance" value="MCF/RBL/QMF 2017 dt 08.04.2019" class='validate[required]'></td>
	...
	$('#ShellProductionTableContainer').jtable({
      ...
      //Create toolbat
                ...
                items: [
                	  {
                          ...
                          text: 'Qauality Control Clearance Memo for Shell',
                          click: function () {
                          	
                          	 var $selectedRows = $('#ShellProductionTableContainer').jtable('selectedRows');
                      	 	 if ($selectedRows.length<1)
                      		 alert("Please select a Shell for which you give clearance");
                      	 	 else{
                      	 		var record;
                    	 	 	...
                    	 	 	$("#shellClearanceMemo").dialog({
                    	 	 		width: '50%',
                    	 	 
                    	 	 		title : 'Testing clearance for Bogie No.: ' +record.shellNumber,                     	 	 		
                    	 	 		close: function (e, u) {
              	 		              //$(".formError").remove();
              	 		          	$("#shellClearanceMemo").validationEngine('hideAll');
                    	 	 		    },
      	 							...
      	 							buttons: {
      	 								Submit: {
                                            ...
                                            var c=confirm("Verify data before submit, Are you sure to save data");
                                         	...
                                         	$.ajax({
                         						url : "clearanceShellMemoEntry",  //action-name as defined in struts.xml
                         						dataType: 'json', 
                         						data : {                       							
                         						...
                         						success : function( msg ) {
                         							...
                         							$('#shellClearanceMemo').dialog('close'),
                         							alert("saving Data");
			...
			actions : {
 			...
 			listAction: 'qualityClearanceFormShellAction?stageID=<%=stageID%>'
