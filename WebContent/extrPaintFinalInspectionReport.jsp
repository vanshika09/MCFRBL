...
int paint_asset_id= Integer.parseInt(request.getParameter("paint_asset_id"));
...
<birt:viewer id="birtViewer" 
				reportDesign="reports/extrPaintFinalInspectionReport.rptdesign"
				pattern="frameset" 
				scrolling="yes" 
				
				showParameterPage="false">
				<birt:param name="paint_asset_id" value='<%=paint_asset_id%>'></birt:param>
