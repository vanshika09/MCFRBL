...
<tr>	
 ...
 <div id="F&PVC" class="tabcontent">
    ...
    <table class="t2" border="1">
		...
		<table border="1">
			<tr><td>Furnishing No.:<input type="text" id="furnishingNoQCI" name="furnishingNoQCI" readonly></td><td colspan="2">Booked To:<input type="text" id="" name=""></td><td>Shell No.:<input type="text" id="shellNo" name="shellNo"></td></tr>
			...
			<tr><td>RLY:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="" name=""></td><td>PP:<input type="text" id="bogiePp" name="bogiePp" readonly></td><td>NPP:<input type="text" id="bogieNpp" name="bogieNpp" readonly></td>
...
// end of retrieving code date picker
		 ...
		 alert("Please select a row for which you want to sent for Perform QCI");
            ...
            if(record.qciTestingFlag==1)
	 		...
	 		$.ajax({
				...
				{
					obj=qciFPvcTrans; 	//set value in obj	
				}
	 		});  
		 if(btn==1){
		 $.ajax({
            ...
            click: function () {
        		 ...
        		 alert("Please select a row for which you want to sent for Perform QCI");
        	 		...
        	 		$selectedRows.each(function () {
						...
						//setting min value
					 	$("#selectStages").dialog({
        	 	 		title : 'Testing for  '+record.shellTransactionId + 'from Stage- <%=stageID%>',
        	 	 		width:'91%',
