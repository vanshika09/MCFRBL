...
<script type="text/javascript">
	...
	//toolbar code
	   {
                    ...
                    text: 'Receipt Semi-Finished Coach from Furnishing Shop',
                    click: function () {
                    	
                    	 var $selectedRows = $('#FurnishingProductionTableContainer').jtable('selectedRows');
                	 	 if ($selectedRows.length<1)
                		 alert("Please select a row for which you want to receipt Coach at Finishing Shop");
                	 	 else{
                	 		var record;
                	 	 	...
                	 	 	$("#receiptDialog").dialog({
                	 	 		...
                	 	 		close: function (e, u) {
                                    ...
                                    Submit: function () {
                                    	...
                                    	$.ajax({
                    						url : "receiptRawCoachAtFinishing",  //action-name as defined in struts.xml
                    						dataType: 'json', 
                    						data : {
	...
	actions : {
 			listAction: 'displayFurnishingAction',
 			  },
