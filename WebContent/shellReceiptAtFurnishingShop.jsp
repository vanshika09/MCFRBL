	...
	//toolbar code
	   {
                    ...
                    click: function () {
                		 ...
                		 alert("Please select a row for which you want to receipt Shell at Furnishing Shop");
                	 	 else{
                	 		var record;
                	 	 	...
                	 	 	$("#receiptDialog").dialog({
                	 	 		...
                	 	 		close: function (e, u) {
                                    ...
                                    Submit: function () {
                                    	...
                                    	$.ajax({
                    						url : "receiptShellAtFurnishing",  //action-name as defined in struts.xml
                    						dataType: 'json', 
                    						data : {
