...
Integer bogieAssetId= Integer.parseInt(request.getParameter("bogieAssetId"));
%>
...
<birt:viewer id="birtViewer" 
				reportDesign="reports/Quality_clearance_memo_bogie.rptdesign"
				pattern="frameset" 
				scrolling="yes" 
				
				showParameterPage="false">

<birt:param name="bogie_asset_id" value='<%=bogieAssetId%>'></birt:param>
