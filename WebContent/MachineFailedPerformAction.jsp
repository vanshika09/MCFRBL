...
%>
 ...
 <div id="performAction" style="height:250px; width:5000px; display:none;z-index: 9;" >
  <br>
...
<script type="text/javascript">
			...
			// add row code by using java script
			 ...
			 $(".add-row").click(function() {
               ...
               //alert("hi");
                ...
                "<input type ='hidden' value='"+srno+"'</td>"+
                "<td><input type='text' class='toUperCase' name='spareDescription' required oninvalid=\"this.setCustomValidity('Enter Spare Name')\" onvalid=\"this.setCustomValidity('')\" id='spareDescription'></input></td>"+
   ...
   $('#spareTable tr:last').remove();
			...
			// end of add row code
$('#datepickerCompletion').datetimepicker({
                               ...
                               click: function () {
                           	 	...
                           	 	$('#datepickerCompletion').datetimepicker('option', 'minDate', new Date(record.dispatchDateForRepair));
                           	 	 	$("#performAction").dialog({
        		 							...
        		 							buttons: {
       	                                    Submit: function () {
											var spareDescriptionArr=[],spareSrNoArr=[];
           	                                    
       	                                    	$('input[name="spareDescription"]').each(function(){
           	                                    	//var spareDescription=$(this).val();
           	                                    	spareDescriptionArr.push($(this).val());
       	                                    	});	
       	                                    	$('input[name="spareSrNo"]').each(function(){
           	                                    	//var spareDescription=$(this).val();
           	                                    	spareSrNoArr.push($(this).val());
       	                                    	});	
       	                                    	...
       	                                    	if ($('#performAction').validationEngine('validate')) {
       	                                    		...
       	                                    		//   alert("spareDescriptionArr->"+spareDescriptionArr) 	   ;
       	                                    		  // return false;
       	                                    	$.ajax({
       	                    						...
       	                    						data : {
       	                    							...
       	                    							remarks:$('#remarks').val(),
       	                    							status: $('#status').val(),
       	                    							spareDescription:JSON.stringify(spareDescriptionArr),
       	                    							spareSrNo:JSON.stringify(spareSrNoArr),
       	                    							rectificationDate: $('#datepickerCompletion').val(),
       	                    							spareReplaced:$('#spareReplaced').val(),
           	                    						},
