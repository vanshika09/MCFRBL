        ...
        <li><s:a href="abnormality-form">Abnormality</s:a></li>
 			...
 			<li><s:a href="add-shop-production">Shop Production</s:a></li>
  			<li><s:a href="add-Asset-gateout">Asset TurnOut/RSP</s:a></li>
   			...
   			<li><s:a href="emp-master">Employee Master </s:a></li>
   			<li><s:a href="annual-target-monthly">Set Monthly Target</s:a></li>
   			<li><s:a href="coach_dispatch_list">Coach Dispatch</s:a></li>
   			<li><s:a href="coach_dispatch">Coach Dispatch Detail</s:a></li>
       	</ul>
 </li>
 <li class="dropdown">
 	<a class="dropdown-toggle" data-toggle="dropdown" href="#">Dashboard
...
<li class="dropdown">
<a class="dropdown-toggle"   data-toggle="dropdown">Manpower Utilization<span class="glyphicon glyphicon-object-align-bottom" ></span></a>
 	 <ul class="dropdown-menu">
     
      <li class="dropdown-submenu">
        <a class="test" tabindex="-1" href="#">Employee Master <span class="glyphicon glyphicon-user"></span></a>
        <ul class="dropdown-menu">
        ...
        <li><s:a href="transfer-emp-within-mcf">Department Transfer Within MCF</s:a></li>
         ...
         <li><s:a href="employee-job-description">Activity Description</s:a></li>
        </ul>
      </li>
</ul>
  </li>
...
<li class="dropdown-submenu">
	...
	<ul class="dropdown-menu">	
		...
		<li><a href="listofbogie?dispatch_to=furnishing">List of Bogie for Furnishing</a></li>
		<li><a href="listofbogie?dispatch_to=rsp">List of Bogie at RSP</a></li>
...
<li class="dropdown-submenu">
	...
	<li><s:a href="paint-shop-production?stageId=4">Paint Shop Production</s:a></li> 
	<li><s:a href="paint-dispatch-production">Shell Dispatch From Paint Shop</s:a></li>   
	 <li><a href="listofpaint">List of Paint</a></li>
	</ul> 
</li> 
<% } 
