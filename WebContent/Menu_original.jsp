...
<li>
<a href="#" class="arrow">Plant Maintenance</a>
<ul>
<li><s:a href="machine-master">Add Machine & Schedule</s:a></li>
<li><s:a href="machine-schedule-due">Overdue Schedule</s:a></li>
<li><s:a href="machine-schedule-failed">Failed Machine</s:a></li>
</ul>
</li>
<li><s:a href="add-coach-production">Add Coach Production</s:a></li>
<li><s:a href="add-shop-production">Add Shop Production</s:a></li> 
