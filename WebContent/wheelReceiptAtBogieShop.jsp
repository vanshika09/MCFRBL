...
<script type="text/javascript">
	...
	//toolbar code
	   {
                    ...
                    text: 'Receipt Wheelset',
                    click: function () {
                    	
                    	 var $selectedRows = $('#WheelsetProductionTableContainer').jtable('selectedRows');
                	 	 if ($selectedRows.length<1)
                		 alert("Please select a row for which you want to receipt wheelset at Bogie Shop");
                	 	 else{
                	 		var record;
                	 	 	...
                	 	 	$("#receiptDialog").dialog({
                	 	 		...
                	 	 		close: function (e, u) {
                                    ...
                                    Submit: function () {
                                    	...
                                    	$.ajax({
                    						url : "receiptWheel",  //action-name as defined in struts.xml
                    						dataType: 'json', 
                    						data : {
	...
	//toolbar code
		...
		title : 'Wheelset Dispatched from Wheel Shop',
