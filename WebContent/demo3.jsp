...
<%
    ...
    System.out.println("Slected railway is: "+railway);
    ...
    */
  	...
  	if((railway.equals("All")) && (coachtype.equals("All")) && (query_year.equals("All")) && (query_month.equals("All")))
  	{
   ...
   else if((query_year.equals("All")) || (query_month.equals("All")))
  		{
  			if( (query_year.equals("All")) && (query_month.equals("All")))
  			{
  				if((railway.equals("All")) && (!coachtype.equals("All")))
  				{
  				...
  				else if((!railway.equals("All")) && (coachtype.equals("All")))
  				{
   ...
   else if((!query_year.equals("All")) && (!query_month.equals("All")) && ((railway.equals("All")) || (coachtype.equals("All"))  ))
		{
			if((railway.equals("All")) && (coachtype.equals("All")) )
			{
