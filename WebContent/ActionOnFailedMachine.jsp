...
Long x=date.getTime();
%>
 <div id="ActionOnFailedMachineTableContainer"></div><br><br> 
 <div id="performAction" style="height:150%; width:200%; display:none;z-index: 9;" >
  <br>
...
$('#datepickerCompletion').datepicker({
	...
	$('#ActionOnFailedMachineTableContainer').jtable({
                       ...
                       items: [
                           {
                               ...
                               click: function () {
                               	 ...
                               	 var $selectedRows = $('#ActionOnFailedMachineTableContainer').jtable('selectedRows');
       	                                    ...
       	                                    Submit: function () {
       	                                    	...
       	                                    	$.ajax({
       	                    						...
       	                    						.done(function( msg ) {
       	                    							...
       	                    							$('#ActionOnFailedMachineTableContainer').jtable('load');
       	         								  })
       	         								.error(function (msg){
       	         									//$('#dialog').dialog('close');
	...
	actions : {
 			listAction: 'listFailedFailedAction',
 			  },
