 	 ...
 	 <li class="root">
 	 	...
 	 	<span class="glyphicon glyphicon-dashboard"></span></a>
 	        <ul class="dropdown-menu">
 	        	...
 	        	<li><s:a href="pert-chart-para">Pert Chart</s:a></li>
 	    ...
 	    <li class="dropdown-submenu">
 	     <a tabindex="-1" href="#">Wheel Shop <span class="glyphicon glyphicon-shopping-cart"></span></a>
 	       <ul class="dropdown-menu">
 	          ...
 	          <li><a href="wheel-sip-wheelaxle?stageId=1">SIP for Wheel &#38; Axle<br> Assembly</a></li>
              <li><a href="wheel-quality-clearance-memo?stageId=1">Issue Quality Clearance</a></li>
              <li><a href="wheel-Quality-Clearance-Report?stageId=1">Wheel Quality Clearance<br> Report</a></li>
...
<!--  	          <li><a href="monthly-production-example">Monthly Production Example</a></li> -->
 		...
 		<span class="glyphicon glyphicon-arrow-right"></span></a>
		    ...
		    <li><a href="list-of-bogie-wheel-prod">Monthly Production Position<br> stage wise</a></li>
 	          	<li><a href="wheel-prod">Annual Production Status<br> of Wheel Shop</a></li>
...
<%--  			<li><s:a href="wheel-RSP-Status-Rly-Distribution">Wheel RSP Status Railway Distribution</s:a></li> --%>
				<li><a href="wheel-quality-clearance-para">Wheel Quality Control Clearance<br> Memo</a></li>
				...
				<li><s:a href="Inspection-Wheel-Axle-Report">SIP REPORT OF Wheel &#38;AXLE<br> ASSEMBLY </s:a></li>
...
<%} if(roles.contains("Bogie")||roles.equals("All"))  {%>
 	<li class="dropdown-submenu">
 		...
 		<ul class="dropdown-menu">	
 			...
 			<li><s:a href="wheel-available-at-bogie">Available Wheel at Bogie<br> Shop</s:a></li>
 			...
 			<li><a href="bogie-Quality-Clearance-Report?stageId=2">Bogie Quality Clearance<br> Report</a></li>
 		...
 		<span class="glyphicon glyphicon-arrow-right"></span></a>
		    ...
		    <li><a href="listofbogie?dispatch_to=rsp">List of Bogie dispatched for RSP</a></li>
 		    ...
 		    <li><s:a href="quarterly_prod_bogie">Bogie Quarterly Prod/ Dis/</s:a></li>
 		     <li><s:a href="Position-RSP">RSP MONTHLY POSITION OF BOGIE<br> AND WHEEL AS ON </s:a></li>
 		    </ul>
 		     </li>
 		     <li class="dropdown-submenu" id="dropMenu">
 		...
 		<span class="glyphicon glyphicon-arrow-right"></span></a>
 		   ...
 		   <li><s:a href="bogie-assembly-yearly-outturn">Bogie Assembly Yearly Outturn</s:a></li>
 			<li><s:a href="output-position-component-bogie">OUTTURN POSITION OF COMPONENT AND<br> BOGIE ASSEMBLY SECTION</s:a></li>
 		    <li><s:a href="daily-report-bogie">DAILY OUTTURN POSITION OF COMPONENT<br> AND BOGIE ASSEMBLY SECTION </s:a></li>
 		    </ul>
 		     </li>
 		    
 		    <li><s:a href="RSP-Status-Rly-Distribution">Monthly Position of RSP (Bogie<br>AND Wheel) As on</s:a></li>
...
<%--   			 <li><s:a href="shop-production-status">Shop wise production status report</s:a></li>--%>
 			   <li><s:a href="daily-attendance-bogie">Daily staff position of Bogie shop</s:a></li>
 		         ...
 		         <li><s:a href="GM-position-bogie">GM Position of Bogie Shop</s:a></li>
 		           ...
 		           <li><s:a href="awaiting-to-dispatch-asondate">AWAITING TO DISPATCH BOGIES<br>FROM BOGIE SHOP AS ON </s:a></li>
 		            <li><s:a href="dispatched-coaches-asondate">DISPATCHED BOGIES FORM<br>BOGIE SHOP AS ON DATE</s:a></li>
 <%-- 		       
 ...
 --%>	             
 		                  <li><s:a href="dispatched-coaches-yearly">Bogie Dispatched year wise from<br>Bogie shop</s:a></li>
 		                   <li><s:a href="coach-holding-yearly">Bogie holding Year wise from<br>Bogie shop</s:a></li>
...
<%--  		  				<li><s:a href="gant-chart-shell-display">Shell production Gant Chart</s:a></li> --%>
 		  				...
 		  				<li><s:a href="shell-duration-in-shop">Variant wise avg duration of Shell<br> in Shell Shop</s:a></li>
...
<%} if(roles.contains("Paint")|| roles.contains("All")) { %>
 	<li class="dropdown-submenu">
 		...
 		<li><s:a href="paint-shop-sip-tran?stageId=4">Interior and Exterior Inspection<br>(SIP and Final) of Painted Shell</s:a></li> 
 		<li><s:a href="paint-shop-insp-clear-tran?stageId=4">Issue testing Clearance of<br> Painted Shell</s:a></li>
 		...
 		<span class="glyphicon glyphicon-arrow-right"></span></a>
 		    <ul class="dropdown-menu">	
 		        ...
 		        <li><s:a href="yearly-dispatched-coaches-paint">Shell dispatched from paint shop<br> yearly</s:a></li>
 		        <li><s:a href="yearly-withheld-coaches-paint">Shell holding at paint shop yearly</s:a></li>
 		       <li class="dropdown-submenu" id="dropMenu">
 		        <a  tabindex="-3" href="#">Production/ Dispatch
 		      <span class="glyphicon glyphicon-arrow-right"></span></a>
 		       <ul class="dropdown-menu">
 		       <li><s:a href="monthly-dispatch-coaches-paint">Shell dispatched from paint<br> shop monthly</s:a></li>
 		        <li><s:a href="monthly-withheld-coaches-paint">Shell holding at paint shop<br> monthly</s:a></li>
 		        <li><s:a href="awaiting-to-dispatch-as-on-date">Shell Awaiting to Dispatch<br> from Paint Shop As on</s:a></li>
 		        <li><s:a href="dispatched-coaches-as-on-date-paint">Dispatched shell from Paint<br> shop as on </s:a></li>
...
<!--  		        <li><s:a href="yearwise">Yearwise Report</s:a></li>  -->
 		        ...
 		        <li><s:a href="paint-duration-in-shop">Variant wise avg duration of Shell<br> in Paint Shop</s:a></li>
 		       <li><s:a href="missing-data-paint">Missing Data Entry Paint Shop</s:a></li>
...
<%}if(roles.contains("Furnishing")|| roles.contains("All")) { %>
 	<li class="dropdown-submenu">
 		...
 		<ul class="dropdown-menu"> 
 			...
 			<li><s:a href="furnishing-dispatch-production">Coach Dispatch from<br> Furnishing Shop</s:a></li>
...
<%--  		    			<li><a href="listoffurnishing?dispatch_to=RSP">List of Shell dispatch from Furnishing</a></li>
 ...
 --%> 		  		   	
             <li class="dropdown-submenu" id="dropMenu">
 		      ...
 		      <span class="glyphicon glyphicon-arrow-right"></span></a>
 		       <ul class="dropdown-menu">
 		       <li><s:a href="paint-to-furnishing">Paint to Furnishing Coaches</s:a></li>
 		       <li><s:a href="coach-prod-status">Coach Production Status Report</s:a></li>
 		       <li><s:a href="daily-position-furnishing">Daily Position Furnishing Shop</s:a></li>
                         ...
                         <li><s:a href="dispatched-coaches-as-on">Coach dispatched as on</s:a></li>
 		  		    	...
 		  		    	<li><a href="pcme_of_furnishing">PCME REPORT OF FURNISHING SHOP</a></li>
 		       </ul>
 		       </li>
<%--                   <li><s:a href="missing-data-Furnishing">Missing Data Entry Quality</s:a></li> --%>
                       <li><a href="furnishingtraceability">Traceability item of furnishing<br> shop</a></li>
                        <li><s:a href="missing-data-furnsishing">Missing Data Entry Furnishing</s:a></li>
                         <li><s:a href="missing-data-furnsishing">Missing Data Entry Furnishing</s:a></li>
 		  		    	<li><s:a href="Furnishing-Report2-RSP">List of Coach Dispatch to<br> Railway</s:a></li>
 		  		    	<li><s:a href="daily-att-furn">Staff position at Furnishing<br> shop as on</s:a></li>
 		  		    	
 		  		    	<li><s:a href="furnishing-duration-in-shop">Variant wise avg duration<br> of Coach in<br> Furnishing Shop</s:a></li>
 		  		    	<li><s:a href="yearly-withheld-coaches">Coach holding position yearly</s:a></li>
 		  		    	<li><a href="cre-lhb-power-car">CRE LHB POWER CAR<br> REPORT</a></li>
 				 		<li><a href="safety_para_da_sets">Safety Parameter DA sets<br> REPORT</a></li>
 				 		<li><a href="shell-defect-report">Shell Defect Report</a></li>
 		    		</ul>
		    	</li>  
 		</ul> 
 	</li>
...
<%--  		<li><s:a href="electric-shop-airdelivery-sip?stageId=5">Air Delivery Test</s:a></li> --%>
 		...
 		<li class="dropdown-submenu">
		    	...
		    	<li><s:a href="issue-cross-check-report">Cross Check Report</s:a></li>
 	...
 	<li class="dropdown-submenu" id="dropMenu">
 	 ...
 	 <% } %> 
 	<li class="dropdown-submenu">
 		<a tabindex="-1" href="#">Coach Production<br> Report
 		<span class="glyphicon glyphicon-shopping-cart"></span></a> 
 		<ul class="dropdown-menu"> 
 		<li><s:a href="yearwise-RSP">Year wise RSP Report</s:a></li>
 		<li><s:a href="coach-outturn-railway">Coach Outturn to Railway</s:a></li>
