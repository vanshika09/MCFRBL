	...
	<TD COLSPAN='2'>
		<DIV ID="toolbar">
			<TABLE CELLSPACING="1px" CELLPADDING="1px" WIDTH="100%" CLASS="birtviewer_toolbar">
				...
				<TR>
					<TD WIDTH="6px"/>
				<%-- below lines commented by Siddhartha/CRIS to hide toggle button in birt report toolbar
					<TD WIDTH="15px">
					...
					<%-- below line commented by Siddhartha/CRIS to hide print on server icon
					<%
